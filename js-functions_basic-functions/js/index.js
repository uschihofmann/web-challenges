...
const bookTitle = "Hitchhikers return";
const author = "EvaDouglas";
const bookRate = 5;
const copiesSold = 10000;

function printPesonalData(bookTitle, author, bookRate, copiesSold) {
console. log(bookTitle + " by " + author + " is rated " + bookRate + " and by now sold " + copiesSold " copies.");
}
